...
3. Check `docs/engine-reference/threejs/breaking-changes.md` when touching R3F-bound UI
   or anything crossing the React boundary. R3F v9 is a React 19 major bump: the
   `MeshProps`-style prop types were removed in favour of `ThreeElements['mesh']`, and
   global JSX namespace augmentation no longer works.
