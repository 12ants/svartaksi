...
- Engine reference: none. This project's engine is three.js, consumed as a pinned npm
  dependency; `pnpm why three` and `node_modules/three` are the authoritative reference.
